...
define('MODULE_PAYMENT_UNZER_ADVANCED_MAESTRO_DK_3D_TEXT', 'Maestro 3D-Secure (Danish)');
define('MODULE_PAYMENT_UNZER_ADVANCED_MASTERCARD_3D_TEXT', 'MasterCard 3D-Secure');
define('MODULE_PAYMENT_UNZER_ADVANCED_MASTERCARD_DK_3D_TEXT', 'Mastercard 3D-Secure (Danish)');
define('MODULE_PAYMENT_UNZER_ADVANCED_MASTERCARD_DEBET_3D_TEXT', 'MasterCard Debit 3D-Secure');
define('MODULE_PAYMENT_UNZER_ADVANCED_MASTERCARD_DEBET_DK_3D_TEXT', 'Mastercard Debit 3D-Secure (Danish)');
define('MODULE_PAYMENT_UNZER_ADVANCED_VISA_3D_TEXT', 'Visa 3D-Secure');
define('MODULE_PAYMENT_UNZER_ADVANCED_VISA_DK_3D_TEXT', 'Visa 3D-Secure (Danish)');
define('MODULE_PAYMENT_UNZER_ADVANCED_VISA_ELECTRON_3D_TEXT', 'Visa Electron 3D-Secure');
define('MODULE_PAYMENT_UNZER_ADVANCED_VISA_ELECTRON_DK_3D_TEXT', 'Visa Electron 3D-Secure (Danish)');
define('MODULE_PAYMENT_UNZER_ADVANCED_VISA_DEBET_3D_TEXT', 'Visacard Debit 3D-secure ');
define('MODULE_PAYMENT_UNZER_ADVANCED_VISA_DEBET_DK_3D_TEXT', 'Visacard Debit 3D-secure (Danish)');
define('MODULE_PAYMENT_UNZER_ADVANCED_CREDITCARD_3D_TEXT', 'Creditcards 3D-secure');
...
define('MODULE_PAYMENT_UNZER_ADVANCED_AMERICAN_EXPRESS_DK_TEXT', 'American Express (Danish)');
define('MODULE_PAYMENT_UNZER_ADVANCED_DANKORT_TEXT', 'Dankort');
define('MODULE_PAYMENT_UNZER_ADVANCED_DINERS_TEXT', 'Diners Club');
define('MODULE_PAYMENT_UNZER_ADVANCED_DINERS_DK_TEXT', 'Diners Club (Danish)');
define('MODULE_PAYMENT_UNZER_ADVANCED_JCB_TEXT', 'JCB');
define('MODULE_PAYMENT_UNZER_ADVANCED_MASTERCARD_TEXT', 'Mastercard');
define('MODULE_PAYMENT_UNZER_ADVANCED_MASTERCARD_DK_TEXT', 'Mastercard (Danish)');
define('MODULE_PAYMENT_UNZER_ADVANCED_MASTERCARD_DEBET_TEXT', 'Mastercard Debit');
define('MODULE_PAYMENT_UNZER_ADVANCED_MASTERCARD_DEBET_DK_TEXT', 'Mastercard Debit(Danish)');
define('MODULE_PAYMENT_UNZER_ADVANCED_VISA_TEXT', 'Visa');
define('MODULE_PAYMENT_UNZER_ADVANCED_VISA_DK_TEXT', 'Visa (Danish)');
define('MODULE_PAYMENT_UNZER_ADVANCED_VISA_ELECTRON_TEXT', 'Visa Electron');
define('MODULE_PAYMENT_UNZER_ADVANCED_VISA_ELECTRON_DK_TEXT', 'Visa Electron (Danish)');
...
define('MODULE_PAYMENT_UNZER_ADVANCED_MOBILEPAY_TEXT', 'Mobilepay payment');
...
// define('MODULE_PAYMENT_UNZER_ADVANCED_IBILL_DESCRIPTION', 'Buy now - pay when you wish');
// define('MODULE_PAYMENT_UNZER_ADVANCED_PAII_TEXT', 'Paii mobile payment');
// define('MODULE_PAYMENT_UNZER_ADVANCED_IBILL_TEXT', 'ViaBill payment');
?>
